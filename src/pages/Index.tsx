  ...
  const handleSyncToServer = async () => {
    if (pendingUploadCount === 0) {
      toast({
        ...
        description: "No valid mutation IDs are currently available in the inventory.",
      });
      return;
    }
    ...
    const description = `Syncing ${pendingUploadCount} mutation records to ${databaseName} at ${serverIp} as ${dbUser}.`;
    ...
    toast({
      ...
      description: `Pushed ${pendingUploadCount} records using the current configuration.`,
    });
